...
class HilbertSpaceChecks:
    ...
    @pytest.fixture
    def y(self, space: "HilbertSpace") -> Vector:
        """A second random vector from the Hilbert space."""
        return space.random()

    @pytest.fixture
    def z(self, space: "HilbertSpace") -> Vector:
    ...
    def test_add_subtract_identity(self, space: "HilbertSpace", x: Vector, y: Vector):
        """Tests if (x + y) - y == x."""
    ...
    def test_multiply_divide_identity(self, space: "HilbertSpace", x: Vector, a: float):
    ...
    def test_ax(self, space: "HilbertSpace", x: Vector, a: float):
    ...
    def test_axpy(self, space: "HilbertSpace", x: Vector, y: Vector, a: float):
    ...
    def test_distributivity(
        self, space: "HilbertSpace", x: Vector, y: Vector, a: float
    ):
    ...
    def test_zero_vector_add_identity(self, space: "HilbertSpace", x: Vector):
        """Tests the additive identity property: x + 0 = x."""
        zero_vec = space.zero
        result_vec = space.add(x, zero_vec)
        assert np.allclose(space.to_components(x), space.to_components(result_vec))

    def test_zero_vector_multiplication(self, space: "HilbertSpace", x: Vector):
        """Tests that 0 * x = 0."""
        zero_vec = space.zero
    ...
    def test_inner_product_symmetry(self, space: "HilbertSpace", x: Vector, y: Vector):
    ...
    def test_inner_product_positive_definite(self, space: "HilbertSpace", x: Vector):
    ...
    def test_norm_triangle_inequality(
        self, space: "HilbertSpace", x: Vector, y: Vector
    ):
    ...
    def test_norm_scalar_multiplication(
        self, space: "HilbertSpace", x: Vector, a: float
    ):
    ...
    def test_to_from_components_identity(self, space: "HilbertSpace", x: Vector):
    ...
    def test_to_from_dual_identity(self, space: "HilbertSpace", x: Vector):
