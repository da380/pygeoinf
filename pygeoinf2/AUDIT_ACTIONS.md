...
- [ ] the primal route on general level functions (non-quadratic convex confidence or constraint sets): the same two-multiplier Lagrangian with a convex minimisation per probe, sharing the likelihood engine's machinery (§59); agreed 2026-09-17 as the item after the quadratic case
