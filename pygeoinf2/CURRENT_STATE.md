...
| `plotting` | fields, points, paths, balls and networks on every geometry; convex sets; marginals, corner plots and error bounds |
...
and `compat` are imported explicitly. Twenty-nine examples under `examples/`
