...
- Before launching parallel searches, find all files matching `<package-root>/plans/*-reference.md` and read every one.
...
- If none exist: proceed with normal parallel strategy below.
